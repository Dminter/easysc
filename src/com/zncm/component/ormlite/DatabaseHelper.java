...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private static final String DATABASE_NAME = "scsql.db";
    ...
    private RuntimeExceptionDao<ScData, Integer> scRuntimeDao = null;
    ...
    public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
        try {
            ...
            TableUtils.createTableIfNotExists(connectionSource, ScData.class);
        } catch (Exception e) {
     ...
     */
    public RuntimeExceptionDao<ScData, Integer> getScDataDao() {
        if (scRuntimeDao == null) {
            scRuntimeDao = getRuntimeExceptionDao(ScData.class);
        }
        return scRuntimeDao;
    }
